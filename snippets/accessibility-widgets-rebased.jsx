...
contentView.append(
  <ScrollView stretch>
    <Composite stretch layout={new StackLayout({alignment: 'stretchX', spacing: 12})} padding={16}>
      <TextView text='Accessibility Properties (custom labels)' font='bold 18px' textColor='navy' padding={8}/>
      <Button id='btn' text='Button' accessibilityLabel='Press me for action!' accessibilityHint='Activates the main action.' accessibilityValue='' accessibilityTraits={['button']}/>
      <TextView id='accessibility-btn' font='12px' textColor='gray' padding={4} text='Loading...'/>
      <TextInput id='txt' message='TextInput' accessibilityLabel='Type your secret message here.' accessibilityHint='Enter text.' accessibilityValue='42' accessibilityTraits={['text']}/>
      <TextView id='accessibility-txt' font='12px' textColor='gray' padding={4} text='Loading...'/>
      <Switch id='switch' accessibilityLabel='Toggle the magic switch.' accessibilityHint='Toggles the magic.' accessibilityValue='on' accessibilityTraits={['switch']}/>
      <TextView id='accessibility-switch' font='12px' textColor='gray' padding={4} text='Loading...'/>
      <Slider id='slider' accessibilityLabel='Slide to adjust the awesomeness.' accessibilityHint='Adjusts the value.' accessibilityValue='50%' accessibilityTraits={['adjustable']}/>
      <TextView id='accessibility-slider' font='12px' textColor='gray' padding={4} text='Loading...'/>
      <Picker id='picker' message='Picker' itemCount={2} itemText={i => ['One', 'Two'][i]} accessibilityLabel='Pick your favorite number.' accessibilityHint='Opens a list.' accessibilityValue='One' accessibilityTraits={['picker']}/>
      <TextView id='accessibility-picker' font='12px' textColor='gray' padding={4} text='Loading...'/>
      <CheckBox id='chk' text='CheckBox' accessibilityLabel='Check this if you agree with the universe.' accessibilityHint='Toggles agreement.' accessibilityValue='checked' accessibilityTraits={['checkbox']}/>
      <TextView id='accessibility-chk' font='12px' textColor='gray' padding={4} text='Loading...'/>
      <TextView id='txtview' text='TextView' accessibilityLabel='Here is some very important text.' accessibilityHint='Static text.' accessibilityValue='' accessibilityTraits={['statictext']}/>
      <TextView id='accessibility-txtview' font='12px' textColor='gray' padding={4} text='Loading...'/>
      <ImageView id='img' image={{src: 'resources/landscape.jpg', width: 300, height: 200}} accessibilityLabel='A beautiful landscape to brighten your day.' accessibilityHint='Decorative image.' accessibilityValue='' accessibilityTraits={['image']}/>
      <TextView id='accessibility-img' font='12px' textColor='gray' padding={4} text='Loading...'/>
      <ProgressBar id='progress' selection={50} accessibilityLabel='Progress bar showing your progress to greatness.' accessibilityHint='Shows progress.' accessibilityValue='50%' accessibilityTraits={['progressbar']}/>
      <TextView id='accessibility-progress' font='12px' textColor='gray' padding={4} text='Loading...'/>
      <ActivityIndicator id='spinner' accessibilityLabel='Loading... Please wait for the magic.' accessibilityHint='Indicates loading.' accessibilityValue='' accessibilityTraits={['indicator']}/>
      ...
      }} accessibilityLabel='Start or stop the spinner.' accessibilityHint='Toggles the spinner.' accessibilityTraits={['button']}/>
      <Composite id='comp' background='#eee' height={32} accessibilityLabel='A mysterious container for widgets.' accessibilityHint='Container.' accessibilityValue='' accessibilityTraits={['container']}/>
      ...
      <ScrollView id='scrollh' stretchX height={72}
          ...
          accessibilityLabel='Scroll horizontally to discover hidden treasures.' accessibilityHint='Scrollable area.' accessibilityValue='' accessibilityTraits={['scrollview']}>
        <TextView id='scroll1' background='red' text='scroll 1' width={300} accessibilityLabel='First scrollable item: red.' accessibilityHint='Scrollable item.' accessibilityTraits={['statictext']}/>
        <TextView id='scroll2' background='green' text='scroll 2' width={300} accessibilityLabel='Second scrollable item: green.' accessibilityHint='Scrollable item.' accessibilityTraits={['statictext']}/>
        <TextView id='scroll3' background='blue' text='scroll 3' width={300} accessibilityLabel='Third scrollable item: blue.' accessibilityHint='Scrollable item.' accessibilityTraits={['statictext']}/>
        <TextView id='scroll4' background='orange' text='scroll 4' width={300} accessibilityLabel='Fourth scrollable item: orange.' accessibilityHint='Scrollable item.' accessibilityTraits={['statictext']}/>
        <TextView id='scroll5' background='purple' text='scroll 5' width={300} accessibilityLabel='Fifth scrollable item: purple.' accessibilityHint='Scrollable item.' accessibilityTraits={['statictext']}/>
      </ScrollView>
      ...
      <Canvas id='canvas' width={100} height={50}
        ...
        accessibilityHint='Canvas drawing.' accessibilityTraits={['canvas']}/>
      <TextView id='accessibility-canvas' font='12px' textColor='gray' padding={4} text='Loading...'/>
      <WebView id='web' url='https://tabrisjs.com' width={320} height={240} accessibilityLabel='Official Tabris.js website. The gateway to awesome.' accessibilityHint='Web content.' accessibilityTraits={['webview']}/>
      ...
      <CollectionView id='colview' width={320} height={120} itemCount={5} cellType={() => 'default'}
        ...
        accessibilityHint='List of items.' accessibilityTraits={['list']}
        createCell={() => (
