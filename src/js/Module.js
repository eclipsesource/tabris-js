(function() {
  ...
  var preliminary = window.tabris = {};
  defineModule(preliminary);
  preliminary._start = function(client) {
    preliminary._client = client;
    preliminary.Module.require("tabris");
    if (tabris !== preliminary) {
      tabris._start(client);
    }
  };
  preliminary._notify = function() {
